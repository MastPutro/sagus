package com.example.sagu.printerAdapter;
...
public class PrintBluetooth extends AppCompatActivity {
    ...
    public void printCatering(String nama, String food, String drink, String rice, String jumlah, String harga){
        try {
            String text = "---------------------\n";
            text += "Nama    : "+nama+"\n";
            text += "Makanan : "+food+"\n";
    ...
    public void printStruk(String meja, String harga, String Date){
